...
They are 24, listed in the book, Martin Fowler's refactoring.

5 categories:

<table border="1">
  <tr>
    <td colspan="2"><strong>Bloaters</strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Passing primitives around with behavior instead of wrapping them in objects</td>
  </tr>
  <tr>
    <td><strong>Repeated Switches</strong></td>
    <td>Same conditional pattern appearing multiple times; branches should be objects</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Subclasses that don't implement all superclass methods and throw exceptions</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2"><strong>Preventors</strong> - Code that prevents easy changes</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>One change requires modifications in many places; should be consolidated</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Sending messages through multiple objects in sequence</td>
  </tr>
  <tr>
...
Watch #5: Identifying the Best Point of Attack



### Get a Whiff of This by Sandi Metz (code smells) exercises Google NotebookLM {#code-smell-talk}
